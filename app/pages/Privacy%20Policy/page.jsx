const Privacy = () => {
  return (
    <div className="m-10">
      ...
      <h2 className="text-2xl mt-1 mb-1">Interpretation and Definitions</h2>
      ...
      <ul className="list-disc">
        ...
        <li className="mt-1">
          <p>
            ...
            this Agreement) refers to aitohumantextconvertor.
          </p>
        </li>
        <li className="mt-1">
          <p>
        ...
        <li className="mt-1">
          <p>
            <strong>Website</strong> refers to aitohumantextconvertor,
            accessible from{" "}
            <a
              href="aitohumantextconvertor.online"
              rel="external nofollow noopener"
              target="_blank"
            >
              aitohumantextconvertor.online
            </a>
          </p>
        </li>
        <li className="mt-1">
      ...
      <h2 className="text-2xl mt-2 mb-1">Collecting and Using Your Personal Data</h2>
      ...
      <ul className="list-disc">
        <li className="mt-1 mb-1">Usage Data</li>
      </ul>
