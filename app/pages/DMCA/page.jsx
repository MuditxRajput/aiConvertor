    ...
    <div className="m-10">
      <div>
        <h2  className="text-2xl mt-1">
          DMCA Generator for <b>aitohumantextconvertor</b>
        </h2>

        <p>
          This Digital Millennium Copyright Act Policy (“Policy”) applies to the{" "}
          <b>aitohumantextconvertor.online</b> website (“Website” or “Service”)
          and any of its related products and services (collectively,
          “Services”) and outlines how this Website operator (“Operator”, “we”,
          “us” or “our”) addresses copyright infringement notifications and how
          you (“you” or “your”) may submit a copyright infringement complaint.
        </p>
        ...
        <h2 className="text-2xl mt-1">What to consider before submitting a copyright complaint</h2>
        ...
        <h2 className="text-2xl mt-1">Notifications of infringement</h2>
        ...
        <h2 className="text-2xl mt-1">Changes and amendments</h2>
        ...
        <p>
          ...
          will post a notification on the main page of the Website. We may also
        ...
        <h2 className="text-2xl mt-1">Reporting copyright infringement</h2>
        ...
        <p>
          ...
          <b>muditrajputpersonal@gmail.com</b>
        </p>
